...
const GoogleOAuthErrorContent = () => {
  ...
  const errorMessage =
    searchParams.get('message') || 'Προέκυψε σφάλμα κατά τη σύνδεση με Google.';
        ...
        <div className='row'>
          <div className='col-lg-6 m-auto wow fadeInUp' data-wow-delay='300ms'>
            <div className='main-title text-center'>
              ...
              <p className='paragraph text-danger mb-4'>{errorMessage}</p>
              <div className='d-flex gap-3 justify-content-center'>
                <LinkNP href='/login' className='ud-btn btn-thm'>
                  Δοκιμάστε ξανά
                </LinkNP>
                <LinkNP href='/' className='ud-btn btn-white2'>
                  Αρχική σελίδα
                </LinkNP>
              </div>
            </div>
