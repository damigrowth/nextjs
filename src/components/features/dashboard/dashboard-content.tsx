...
import { ArrowRight, BarChart3, MessageSquare, Settings, Plus, Users } from 'lucide-react';
...
export default async function DashboardContent() {
  ...
  const userHasAccess = professionalResult.success ? professionalResult.data : false;

  const userId = user?.id;
  const displayName = user?.displayName || user?.name || profile?.firstName || 'User';
    ...
    return (
      <Card>
          <CardHeader>
            ...
            <CardDescription>
              Μπορείς να συμπληρώσεις τα στοιχεία σου και να εξερευνήσεις την πλατφόρμα.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              ...
              . Ακόμα, μπορείς να αποθηκεύσεις τις Αγαπημένες σου υπηρεσίες και τα προφίλ.
              Εάν έχεις έρθει σε επικοινωνία με κάποιον επαγγελματία, μη διστάσεις να υποβάλεις μια αξιολόγηση.
