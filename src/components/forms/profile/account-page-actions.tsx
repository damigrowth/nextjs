  ...
  return (
    <div className='flex flex-col sm:flex-row gap-4'>
      ...
      <Dialog open={deleteAccountOpen} onOpenChange={setDeleteAccountOpen}>
        <DialogTrigger asChild>
          <Button variant='outline' className='flex items-center gap-2 bg-white text-muted-foreground hover:bg-gray-50 hover:text-muted-foreground/80 border-muted transition-all'>
