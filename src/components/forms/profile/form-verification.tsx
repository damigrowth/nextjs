      ...
      >
        ...
        {verificationData?.status !== 'APPROVED' && (
          <Alert>
            ...
            <AlertDescription>
              <strong>Σημαντικό:</strong> Τα στοιχεία θα
              χρησιμοποιηθούν για τη διασταύρωση ότι το ΑΦΜ σας αντιστοιχεί σε ενεργό επαγγελματία / επιχείρηση. Η
              διαδικασία ελέγχου συνήθως διαρκεί 1-2 εργάσιμες ημέρες.
            </AlertDescription>
          </Alert>
        )}
