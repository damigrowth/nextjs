...
// Auth provider
import { useAuthUser } from '@/components/providers/auth';
  ...
  const onSubmit = async (data: DeleteAccountFormData) => {
    startTransition(async () => {
      ...
      try {
        ...
        if (!result.success) {
          throw new Error(result.error || 'Σφάλμα κατά τη διαγραφή λογαριασμού');
        }
        ...
        setSubmitError(
          error.message || 'Αποτυχία διαγραφής λογαριασμού. Παρακαλώ δοκιμάστε ξανά.'
        );
      }
    });
  };
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          Αυτή η ενέργεια είναι μη αναστρέψιμη. Όλα τα δεδομένα σας θα διαγραφούν οριστικά.
        </DialogDescription>
        <div className="pb-4">
          <p className="text-sm text-muted-foreground">
            Θα διαγραφούν: το προφίλ σας, οι υπηρεσίες σας, τα μηνύματά σας, και όλα τα σχετικά δεδομένα.
          </p>
        </div>
      </DialogHeader>
      ...
      <Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              <strong>Προσοχή:</strong> Αυτή η ενέργεια δεν μπορεί να αναιρεθεί. Όλα τα δεδομένα σας θα χαθούν οριστικά.
            </AlertDescription>
          </Alert>
