...
import PaymentMethods from "./archives-freelancers-payment-methods";
import Coverage from "./archives-freelancers-coverage";
import Category from "./archives-freelancers-category";
import Content from "./archives-freelancers-content";
import ContentSkeleton from "./archives-freelancers-skeleton";
import SidebarModal from "./sidebar-modal";
import Verified from "./verified";
import Skills from "./archives-freelancers-skills";
