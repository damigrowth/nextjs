...
import { NavigationButtons, SaveButton } from '../button';
import {
  ServiceAddons,
  ServiceFaq,
  ServiceGallery,
        ...
        {serviceId ? (
          ...
          <>
            ...
            {errors && errors.active && (
              <AlertForm message={errors.message} type='danger' />
            )}
            {/* Display validation errors from state */}
            {validationErrors && validationErrors.active && (
              <AlertForm message={validationErrors.message} type='danger' />
            )}
            {/* Display form submission errors */}
            {formState.errors && (
              <AlertForm message={formState.message} type='danger' />
            )}
            <NavigationButtons
