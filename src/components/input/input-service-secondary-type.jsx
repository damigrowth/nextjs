      ...
      {type.online && (
        <div className='pt20'>
          <h4 className='list-title pb10'>
            Προσφέρετε την συγκεκριμένη απομακρυσμένη υπηρεσία, <br /> με τη
            μορφή συνδρομής ή μπορεί να εκτελείται για μια φορά (one-off) χωρίς
            απαραίτητα να επαναλαμβάνεται;
          </h4>
          <div className='mb20-lg mt20 mb30'>
            <button
              className={`ud-btn btn-thm2 add-joining ${type.subscription ? 'active' : ''}`}
              type='button'
            ...
            <button
              className={`ud-btn btn-thm2 add-joining mr10-lg mr20 ${type.oneoff ? 'active' : ''}`}
              type='button'
      ...
      {type.presence && (
        <div className='pt20'>
          ...
          <div className='mb20-lg mb20'>
            <button
              className={`ud-btn btn-thm2 add-joining mr10-lg mr20 ${type.onbase ? 'active' : ''}`}
              type='button'
            ...
            <button
              className={`ud-btn btn-thm2 add-joining ${type.onsite ? 'active' : ''}`}
              type='button'
