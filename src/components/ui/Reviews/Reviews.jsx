...
export default async function Reviews({
  ...
  if (reviews.length === 0 && (!otherServicesReviews || otherServicesReviews.length === 0)) {
    return <h4 className="mt40 mb20">Χωρίς Αξιολογήσεις</h4>;
  }

  return (
    <div id="reviews-section" className="px30 mt40 bdr1 pt30 pb-0 mb30 bg-white bdrs12 wow fadeInUp default-box-shadow1">
          ...
          <div className="row">
            ...
            {reviews.length > 0 && (
              <div className="col-md-12">
                <LoadMoreBtn
                  name="Αξιολογήσεις"
                  total={reviews.length < reviews_total ? reviews.length : reviews_total}
              ...
              <>
                <div className="col-lg-12">
                  <div className="total_review mb30 mt45">
                    <h4>{otherServicesReviews.length} {otherServicesReviews.length === 1 ? 'αξιολόγηση από άλλες υπηρεσίες' : 'αξιολογήσεις από άλλες υπηρεσίες'}</h4>
                  </div>
                </div>
                <ul>
