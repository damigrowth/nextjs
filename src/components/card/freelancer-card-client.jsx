...
export default function FreelancerCardClient({
  freelancer,
  fid,
  linkedName,
  showDelete,
  ...
  // Always show save button unless it's the user's own card
  const showSaveButton = !fid || fid !== id;

  return (
    <>
      <div className='data-loading-element freelancer-style1 text-center bdr1 hover-box-shadow posiiton-relative w-100'>
        {/* Show save button unless it's the user's own card */}
        {showSaveButton && (
          <SaveForm
            type='freelancer'
            id={id}
