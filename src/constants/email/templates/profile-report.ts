 ...
 *
 * HTML template for notifying admin when a profile is reported
 */
                ...
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                  <tr>
                    <td style="color: #153643;">
                      <h1 style="font-size: 24px; margin: 0 0 10px 0; font-family: Arial, sans-serif; color: #333;">⚠️ Αναφορά Προφίλ</h1>
                      ...
                      <a href="https://doulitsa.gr/profile/${data.profileId}" style="background: #1f4c40; color: #ffffff; text-decoration: none; padding: 16px 30px; border-radius: 4px; display: inline-block; margin: 10px 10px 10px 0; font-weight: 700;">
                        Προβολή Προφίλ
                      </a>
